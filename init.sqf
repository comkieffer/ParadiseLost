...
Note0 = [
	"Mission Details",
	"You must rescue Mark Thompson, he was captured by insurgents 2 days ago. This morning a Global Hawk reconaissance drone located the compound he is being held in. The compound, in the city of Agresoran is composed of 3 seperate buildings. We reccomend storming them all at once to stop the enemy from calling in reinforcements.<br/>We estimate no more than 15 enemy fighters in the Immediate area but they probably have support troops in the mountain villages to the south of the target compound.<br/> Once You have secured the hostage take him to xxxxxx and call for an extraction.<br/>The CIA has mobilised it's HUMINT assets in the area and will forward any extra information they have on the situation."
];

Note1 = [
	"Factions",
	"The region is for all intents and purposes out of reach of the government. The UN troops in the region rarely venture West of Ovallestàn for fear of being attacked by Islamist radicals that have made the region into a major open air training camp.<br/> The UN forces will be neutral with regards to foreigners. The civilians though might be less friendly. There are currently riots in front of the Amercan consulate in Ovallstàn.<br/> Insurgents will be present in the country side west of Ovallestàn. The town of Demenazhir is a hotspot of insurgent activity and you should expect a strong insurgent presence in the town and it's suburbs. There may also be patrols on the roads from Ovallestàn to Demenazhir."
];

Note2 = [
	"Mark Thompson",
	"Mark Thompson, a journalist for the 'Old Yorker' was in the country to write a profile on an insurgent leader. His newspaper tells us that he had secured an interview with him. Unfortunately he never returned from the interview."
];
...
task0 = [
	"RescueHostage",
	"Rescue the Hostage",
	"Rescue the american captive and subdue his captors. Let them know that America does not negotiate with terrorsits."
];
